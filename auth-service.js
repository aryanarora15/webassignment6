...
function initialize() {
    return new Promise((resolve, reject) => {
        ...
        let db = mongoose.createConnection("mongodb+srv://aryansgnr2003:Arora2345@cluster0.0t1lfp8.mongodb.net/?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true});
        // Checking for errors
        db.on('error', (err)=>{
            reject(err);
        });
